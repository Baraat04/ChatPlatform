        ...
        <div className="space-y-6 font-light text-slate-700 text-sm leading-relaxed bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
          {language === 'RU' && (
            <>
              ...
              <p>
                5.6. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать по электронной почте <strong>geducation1017@gmail.com</strong> или по телефонам: <strong>+7 777 430-71-95</strong>
              </p>
            </>
          )}
